...
public class DynamicBayesNet {
	...
	public DynamicBayesNet(DynamicBayesNet dbn) {
		this.attributes = new ArrayList<Attribute>(dbn.getAttributes());
		this.initialNet = dbn.getInit();
		this.transitionNets = new ArrayList<BayesNet>(dbn.getTrans());
		this.markovLag = dbn.getTrans().get(0).getMarkovLag();
	}
